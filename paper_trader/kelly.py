...
#
# We use Quarter-Kelly as the conservative variant to reduce variance
# while building confidence in new probability models.
#
# CAPS:
...
FALLBACK_POSITION_EUR: float = 100.0

# Use Quarter-Kelly by default
