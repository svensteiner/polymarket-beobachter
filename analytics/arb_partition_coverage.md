...
**Generiert:** 2026-08-29T17:00:23.973169+00:00  
**Roh-Snapshots ausgewertet:** 622 · Half-Spread 0.0052 · Lead 24.0h  
...
- negRisk-Partitionen gesamt (≥3 Buckets): **358**
- davon in unserem beobachteten+aufgelösten Universum (tägliche Stadt-Temp): **12**
...
| Preis-Coverage mean | 13.6% |
| Preis-Coverage max | 27.3% |
...
- Der *tatsächliche* Blocker ist **Preis-Coverage**: wir bepreisen im Median nur **9.1%** der Buckets einer Partition, im Maximum **27.3%**, und **keine einzige** Partition ist vollständig bepreist. Wer eine unvollständige Bucket-Menge kauft, kennt S nicht und kann in ~⅔ der Fälle den Gewinner-Bucket gar nicht gekauft haben.
