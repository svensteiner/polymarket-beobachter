...
**Lauf:** 2026-08-06T17:00:26.667656+00:00  
**Status:** OK
...
| Hypothesen getestet / OOS n | 15 / 1386 |
| Bester Kandidat | `no_fade_10_20` · net +0.68% · t=0.979 · q=1.0 |
| Regime-Guard | ✅ aktiv |
| Forward aufgelöst (Gate 1: 150) | 259 |
| Kandidaten-Kohorte (exact+eng) | n=56 · net real +0.76% |
| Modell-Skill-Nische (B4) | KEINE (getestet 2 Zellen · Δ OOS -1.74%) |
| Arbitrage erntbar | nein (-2.73%/Set) |
| Arb-Partitionen (negRisk) | 0/53 vollständig · Preis-Coverage median 9.1% / max 36.4% |
| Half-Spread (kalibriert) | 0.00164 |
